...
mnemonics = ['defy', 'govern', 'theme', 'fox', 'major', 'found', 'dumb', 'sea', 'garage', 'cigar', 'build', 'coin', 'nominee', 'employ', 'column', 'glass', 'cash', 'symbol', 'bench', 'rifle', 'office', 'puzzle', 'prefer', 'hire']
mnemonics_100TON = ['nephew', 'draw', 'miss', 'canal', 'nothing', 'cheese', 'runway', 'reveal', 'vast', 'addict', 'broken', 'tube', 'flower', 'patient', 'fatigue', 'impulse', 'section', 'together', 'carpet', 'smoke', 'lecture', 'canvas', 'obscure', 'planet']
